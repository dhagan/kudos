(function () {
  ...
  TeamsController.$inject = ['$scope', '$state', 'Authentication', 'teamResolve', 'Users', 'OrganizationsService'];

  function TeamsController ($scope, $state, Authentication, team, Users, OrganizationsService) {
    var vm = this;
